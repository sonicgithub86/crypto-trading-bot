...
module.exports = class {
  ...
  buildIndicator(indicatorBuilder, options) {
    indicatorBuilder.add('ema', 'ema', '30m', {
      length: 12
    });
    indicatorBuilder.add('ema', 'ema', '30m', {
      length: 34
    });
    // indicatorBuilder.add('stoch', 'stoch', '30m', {
    //   length: 5,
    //   k: 3,
    //   d: 3
    // });
  ...
  async period(indicatorPeriod, options) {
    ...
    const stoch1 = indicatorPeriod.getIndicator('stoch1');
    ...
    if (stoch1) {
      console.log('Stoch1 Values');
      var stochKeys = Object.keys(stoch1);
      console.log('Stoch1 Values LENGTH ' + stochKeys.length);
      // stochKeys.forEach(function (key) {
      //   var stoch = stoch1[key];
      //   console.log('Stoch_d ' + stoch.stoch_d);
      //   console.log('Stoch_k ' + stoch.stoch_k);
      //   console.log('\n');
      // });
    }
